...
static void *string_to_val(SettingDesc *desc, const char *str)
{
	unsigned long val;
	char *end;
...
static void load_setting_desc(IniFile *ini, SettingDesc *desc, void *grpname, void *base)
{
...
static void save_setting_desc(IniFile *ini, SettingDesc *desc, void *grpname, void *base)
{
	IniGroup *group_def = ini_getgroup(ini, grpname, -1), *group;
	IniItem *item;
	void *p, *ptr;
...
static SettingDesc music_settings[] = {
...
static SettingDesc misc_settings[] = {
	...
	{"language", SDT_STRINGBUF | lengthof(_dynlang.curr_file)<<16, "english.lng", _dynlang.curr_file },
	...
	{"force_full_redraw", SDT_BOOL | SDT_NOSAVE, (void*)false, &_force_full_redraw},
	{NULL}
};

static SettingDesc gameopt_settings[] = {
	...
	{"currency", SDT_UINT8 | SDT_ONEOFMANY, (void*)0, (void*)offsetof(GameOptions, currency), "GBP|USD|FF|DM|YEN|PT|FT|ZL|ATS|BEF|DKK|FIM|GRD|CHF|NLG|ITL|SEK|RUR|EUR" },
	{"distances", SDT_UINT8 | SDT_ONEOFMANY, (void*)0, (void*)offsetof(GameOptions, kilometers), "imperial|metric" },
	{"town_names", SDT_UINT8 | SDT_ONEOFMANY, (void*)0, (void*)offsetof(GameOptions, city_name), "english|french|german|american|latin|silly|swedish|dutch|finnish" },
...
static SettingDesc patch_settings[] = {
	...
	{"noinflation", SDT_BOOL, (void*)false, (void*)offsetof(Patches, noinflation)},
	...
	{"crossing_tunnels", SDT_BOOL, (void*)false, (void*)offsetof(Patches, crossing_tunnels)},
	...
	{"train_income_warn", SDT_INT32, (void*)0, (void*)offsetof(Patches, train_income_warn)},
...
typedef void SettingDescProc(IniFile *ini, SettingDesc *desc, void *grpname, void *base);
