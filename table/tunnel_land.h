...
static const SpriteID _draw_tunnel_table_3[] = {
	0xF8D, 0xFDD,
};

static const SpriteID _draw_tunnel_table_4[] = {
	0x11C6, 0xFDD,
};

static const SpriteID _draw_tunnel_table_5[] = {
	0x3F3, 0x3F4, 0xF8D, 0xF8D, 0, 0
};

static const SpriteID _draw_tunnel_table_6[] = {
	0x40D, 0x40E, 0x11C6, 0x11C6, 0, 0
};

static const SpriteID _draw_tunnel_table_7[] = {
	0, 0, 0x534, 0x535, 0, 0
};

static const SpriteID _draw_tunnel_table_8[] = {
	0, 0, 0x547, 0x548, 0, 0
};
