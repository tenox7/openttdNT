...
const byte _station_display_datas_0[] = {
...
const byte _station_display_datas_1[] = {
...
const byte _station_display_datas_2[] = {
	TILE_SEQ_BEGIN(0x3F4)
...
const byte _station_display_datas_3[] = {
	TILE_SEQ_BEGIN(0x3F3)
...
const byte _station_display_datas_4[] = {
	TILE_SEQ_BEGIN(0x3F4)
...
const byte _station_display_datas_5[] = {
	TILE_SEQ_BEGIN(0x3F3)
...
const byte _station_display_datas_6[] = {
	TILE_SEQ_BEGIN(0x3F4)
	TILE_SEQ_LINE(  0,  0,  0, 16,  5,  2, 0x842E)
...
const byte _station_display_datas_7[] = {
	TILE_SEQ_BEGIN(0x3F3)
	TILE_SEQ_LINE(  0,  0,  0,  5, 16,  2, 0x842F)
...
const byte _station_display_datas_8[] = {
	TILE_SEQ_BEGIN(0xA4A)
	TILE_SEQ_END()
};

const byte _station_display_datas_9[] = {
	TILE_SEQ_BEGIN(0xA4A)
	TILE_SEQ_LINE(  0,  0,  0, 16,  1,  6, 0x8A68)
	TILE_SEQ_END()
};

const byte _station_display_datas_10[] = {
	TILE_SEQ_BEGIN(0xA4A)
	TILE_SEQ_LINE( 15,  0,  0,  1, 16,  6, 0x8A67)
	TILE_SEQ_END()
};

const byte _station_display_datas_11[] = {
	TILE_SEQ_BEGIN(0xA4B)
	TILE_SEQ_END()
};

const byte _station_display_datas_12[] = {
	TILE_SEQ_BEGIN(0xA4C)
	TILE_SEQ_END()
};

const byte _station_display_datas_13[] = {
	TILE_SEQ_BEGIN(0xA4D)
	TILE_SEQ_END()
};

const byte _station_display_datas_14[] = {
	TILE_SEQ_BEGIN(0xA4E)
	TILE_SEQ_END()
};

const byte _station_display_datas_15[] = {
	TILE_SEQ_BEGIN(0xA4F)
	TILE_SEQ_END()
};

const byte _station_display_datas_16[] = {
	TILE_SEQ_BEGIN(0xA50)
	TILE_SEQ_END()
};

const byte _station_display_datas_17[] = {
	TILE_SEQ_BEGIN(0xA51)
	TILE_SEQ_END()
};

const byte _station_display_datas_18[] = {
	TILE_SEQ_BEGIN(0xA52)
	TILE_SEQ_END()
};

const byte _station_display_datas_19[] = {
	TILE_SEQ_BEGIN(0xA53)
	TILE_SEQ_END()
};

const byte _station_display_datas_20[] = {
	TILE_SEQ_BEGIN(0xA54)
	TILE_SEQ_END()
};

const byte _station_display_datas_21[] = {
	TILE_SEQ_BEGIN(0xA53)
	TILE_SEQ_LINE( 15,  0,  0,  1, 16,  6, 0x8A67)
	TILE_SEQ_END()
};

const byte _station_display_datas_22[] = {
	TILE_SEQ_BEGIN(0xA55)
	TILE_SEQ_LINE(  0, 15,  0, 16,  1,  6, 0x8A68)
	TILE_SEQ_END()
};

const byte _station_display_datas_23[] = {
	TILE_SEQ_BEGIN(0xA56)
	TILE_SEQ_LINE(  0, 15,  0, 16,  1,  6, 0x8A68)
	TILE_SEQ_END()
};

const byte _station_display_datas_24[] = {
	TILE_SEQ_BEGIN(0xA57)
	TILE_SEQ_LINE(  0, 15,  0, 16,  1,  6, 0x8A68)
	TILE_SEQ_END()
};

const byte _station_display_datas_25[] = {
	TILE_SEQ_BEGIN(0xA58)
	TILE_SEQ_LINE(  0, 15,  0, 16,  1,  6, 0x8A68)
	TILE_SEQ_END()
};

const byte _station_display_datas_26[] = {
	TILE_SEQ_BEGIN(0xA59)
	TILE_SEQ_LINE(  0, 15,  0, 16,  1,  6, 0x8A68)
	TILE_SEQ_END()
};

const byte _station_display_datas_27[] = {
	TILE_SEQ_BEGIN(0xA4A)
	TILE_SEQ_LINE(  2,  0,  0, 11, 16, 40, 0x8A5A)
	TILE_SEQ_END()
};

const byte _station_display_datas_28[] = {
...
const byte _station_display_datas_29[] = {
	TILE_SEQ_BEGIN(0xA4A)
	TILE_SEQ_LINE(  0,  1,  0, 14, 14, 30, 0x8A5C)
	TILE_SEQ_END()
};

const byte _station_display_datas_30[] = {
	TILE_SEQ_BEGIN(0xA4A)
	TILE_SEQ_LINE(  3,  3,  0, 10, 11, 35, 0x8A5D)
	TILE_SEQ_END()
};

const byte _station_display_datas_31[] = {
	TILE_SEQ_BEGIN(0xA4A)
	TILE_SEQ_LINE(  0,  3,  0, 16, 11, 40, 0x8A5E)
	TILE_SEQ_END()
};

const byte _station_display_datas_32[] = {
	TILE_SEQ_BEGIN(0xA4A)
...
const byte _station_display_datas_33[] = {
	TILE_SEQ_BEGIN(0xA4B)
...
const byte _station_display_datas_34[] = {
	TILE_SEQ_BEGIN(0xA4B)
	TILE_SEQ_LINE(  2,  7,  0,  3,  3, 14, 0xA64)
	TILE_SEQ_END()
};

const byte _station_display_datas_35[] = {
	TILE_SEQ_BEGIN(0xA4A)
	TILE_SEQ_LINE(  3,  2,  0,  3,  3, 14, 0xA65)
	TILE_SEQ_END()
};

const byte _station_display_datas_36[] = {
	TILE_SEQ_BEGIN(0xA4A)
	TILE_SEQ_LINE(  0,  8,  0, 14,  3, 14, 0xA66)
	TILE_SEQ_END()
};

const byte _station_display_datas_37[] = {
	TILE_SEQ_BEGIN(0xF8D)
	TILE_SEQ_END()
};

const byte _station_display_datas_38[] = {
	TILE_SEQ_BEGIN(0xF8D)
	TILE_SEQ_LINE(  0,  0,  0,  1, 16,  6, 0x8A67)
	TILE_SEQ_END()
};

const byte _station_display_datas_39[] = {
	TILE_SEQ_BEGIN(0xF8D)
...
const byte _station_display_datas_40[] = {
	TILE_SEQ_BEGIN(0xF8D)
...
const byte _station_display_datas_41[] = {
	TILE_SEQ_BEGIN(0xF8D)
...
const byte _station_display_datas_42[] = {
	TILE_SEQ_BEGIN(0xF8D)
...
const byte _station_display_datas_43[] = {
	TILE_SEQ_BEGIN(0xF8D)
...
const byte _station_display_datas_44[] = {
	TILE_SEQ_BEGIN(0xF8D)
...
const byte _station_display_datas_45[] = {
	TILE_SEQ_BEGIN(0xF8D)
...
const byte _station_display_datas_46[] = {
	TILE_SEQ_BEGIN(0xF8D)
...
const byte _station_display_datas_47[] = {
	TILE_SEQ_BEGIN(0xF8D)
...
const byte _station_display_datas_48[] = {
	TILE_SEQ_BEGIN(0xF8D)
...
const byte _station_display_datas_49[] = {
	TILE_SEQ_BEGIN(0xF8D)
...
const byte _station_display_datas_50[] = {
	TILE_SEQ_BEGIN(0xF8D)
...
const byte _station_display_datas_51[] = {
	TILE_SEQ_BEGIN(0xF8D)
...
const byte _station_display_datas_52[] = {
	TILE_SEQ_BEGIN(0xA69)
	TILE_SEQ_END()
};

const byte _station_display_datas_53[] = {
	TILE_SEQ_BEGIN(0xA6A)
	TILE_SEQ_END()
};

const byte _station_display_datas_54[] = {
	TILE_SEQ_BEGIN(0x8A6B)
	TILE_SEQ_LINE(  0,  0,  0, 15, 15, 30, 0x8A6C)
	TILE_SEQ_END()
};

const byte _station_display_datas_55[] = {
	TILE_SEQ_BEGIN(0xA6D)
	TILE_SEQ_LINE( 15,  0,  0,  1, 16,  6, 0x8A67)
	TILE_SEQ_END()
};

const byte _station_display_datas_56[] = {
	TILE_SEQ_BEGIN(0xA6E)
	TILE_SEQ_END()
};

const byte _station_display_datas_57[] = {
	TILE_SEQ_BEGIN(0xA6F)
	TILE_SEQ_END()
};

const byte _station_display_datas_58[] = {
...
const byte _station_display_datas_59[] = {
	TILE_SEQ_BEGIN(0xA70)
	TILE_SEQ_LINE(  0,  0,  0,  1, 16,  6, 0x8A67)
...
const byte _station_display_datas_60[] = {
	TILE_SEQ_BEGIN(0xA70)
	TILE_SEQ_LINE(  0,  0,  0,  1, 16,  6, 0x8A67)
...
const byte _station_display_datas_61[] = {
	TILE_SEQ_BEGIN(0xA70)
	TILE_SEQ_LINE(  0,  0,  0,  1, 16,  6, 0x8A67)
...
const byte _station_display_datas_62[] = {
	TILE_SEQ_BEGIN(0xA71)
	TILE_SEQ_LINE(  0, 15,  0, 16,  1,  6, 0x8A68)
	TILE_SEQ_END()
};

const byte _station_display_datas_63[] = {
	TILE_SEQ_BEGIN(0xA72)
	TILE_SEQ_LINE(  0, 15,  0, 16,  1,  6, 0x8A68)
	TILE_SEQ_END()
};

const byte _station_display_datas_64[] = {
	TILE_SEQ_BEGIN(0xA73)
	TILE_SEQ_LINE(  0, 15,  0, 16,  1,  6, 0x8A68)
	TILE_SEQ_END()
};

const byte _station_display_datas_65[] = {
	TILE_SEQ_BEGIN(0xA4A)
...
const byte _station_display_datas_66[] = {
	TILE_SEQ_BEGIN(0xF8D)
	TILE_SEQ_LINE(  0,  0,  0, 16, 16, 60, 0x8A49)
	TILE_SEQ_END()
};

const byte _station_display_datas_67[] = {
...
const byte _station_display_datas_68[] = {
...
const byte _station_display_datas_69[] = {
...
const byte _station_display_datas_70[] = {
...
const byte _station_display_datas_71[] = {
...
const byte _station_display_datas_72[] = {
...
const byte _station_display_datas_73[] = {
...
const byte _station_display_datas_74[] = {
