...
void SetupDateTime()
{
	...
	_date = _starting_date ? _starting_date : 10958;
	_date_fract = 0;
...
const int16 _tileoffs_by_dir[4] = {
	TILE_XY(-1, 0),
	TILE_XY(0, 1),
	TILE_XY(1, 0),
	TILE_XY(0, -1),
...
{
	return IS_INT_INSIDE(GET_TILE_X(tile), distance, TILES_X - distance) &&
			IS_INT_INSIDE(GET_TILE_Y(tile), distance, TILES_Y - distance);
}
...
void IncreaseDate()
{
	...
	/* if the day changed, call the vehicle event (but max 12 at a time) */
	ctr = _vehicle_id_ctr_day;
	for(i=0; i!=12 && ctr != lengthof(_vehicles); i++) {
	...
	/* check if we reached 2070, that's the maximum year. */
	if (_cur_year == 151) {
		_cur_year = 150;
		_date = 54788;
	}
...
static const SaveLoadGlobVarList _date_desc[] = {
	{&_date, SLE_UINT16},
	{&_date_fract, SLE_UINT16},
	{&_tick_counter, SLE_UINT16},
	{&_vehicle_id_ctr_day, SLE_UINT16},
	{&_age_cargo_skip_counter, SLE_UINT8},
	{&_avail_aircraft, SLE_UINT8},
	{&_cur_tileloop_tile, SLE_UINT16},
	{&_disaster_delay, SLE_UINT16},
	{&_station_tick_ctr, SLE_UINT16},
	{&_random_seed_1, SLE_UINT32},
	{&_random_seed_2, SLE_UINT32},
	{&_cur_town_ctr, SLE_UINT8},
	{&_cur_player_tick_index, SLE_FILE_U8 | SLE_VAR_UINT},
	{&_next_competitor_start, SLE_FILE_U16 | SLE_VAR_UINT},
	{&_trees_tick_ctr, SLE_UINT8},
	{NULL,0}
};
...
static const SaveLoadGlobVarList _view_desc[] = {
	{&_saved_scrollpos_x, SLE_FILE_I16 | SLE_VAR_INT},
	{&_saved_scrollpos_y, SLE_FILE_I16 | SLE_VAR_INT},
	{&_saved_scrollpos_zoom, SLE_UINT8},
	{NULL,0}
};
