...
typedef uint16 GetSlopeZProc(TileInfo *ti);
...
enum SpecialStrings {
	...
	SPECSTR_TOWNNAME_LAST = SPECSTR_TOWNNAME_FINNISH,

	// special strings for player names on the form "CityName transport".
