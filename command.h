enum {
	...
	CMD_BUILD_TUNNEL = 13,
	CMD_CLEAR_TUNNEL_TILE = 14,
	CMD_CLEAR_BRIDGE_TILE = 15,
	...
	CMD_MODIFY_TRAIN_ORDER = 42,
	CMD_SKIP_TRAIN_ORDER = 43,
	CMD_DELETE_TRAIN_ORDER = 44,
	CMD_INSERT_TRAIN_ORDER = 45,
	...
	CMD_BUILD_TOWN = 77,
	CMD_BUILD_TOWN_HOUSE = 78,
	CMD_CLEAR_TOWN_HOUSE = 79,
	CMD_RENAME_TOWN = 80,
	CMD_DO_TOWN_ACTION = 81,

	CMD_SET_ROAD_DRIVE_SIDE = 82,
	CMD_SET_CITY_NAME_TYPE = 83,

	CMD_EXIT_TO_GAME_MENU = 84,
...
enum {
	...
	DC_NO_CITY_RATING = 0x40,		// city rating does not disallow you from building
	DC_SET_ERR = 0x8000,
	CMD_ERROR = ((int32)0x80000000),
};

#define DC_MSG(x) (((x)<<16)|DC_SET_ERR)

//#define return_cmd_error(errcode) do { _error_message=(errcode); return CMD_ERROR; } while(0)
#define return_cmd_error(errcode) do { return 0x80000000 | (errcode); } while (0)
